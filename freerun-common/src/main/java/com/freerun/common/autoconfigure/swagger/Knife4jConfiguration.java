...
import com.freerun.common.utils.TjTemporalConverter;
...
@Configuration
@ConditionalOnProperty(prefix = "freerun.swagger", name = "enable",havingValue = "true")
...
public class Knife4jConfiguration {
    ...
    @Bean
    @Primary
    @ConditionalOnProperty(prefix = "freerun.swagger", name = "enableResponseWrap",havingValue = "true")
