...
import com.freerun.media.storage.tencent.TencentFileStorage;
import com.freerun.media.storage.tencent.TencentMediaStorage;
...
public class TencentConfig {
    ...
    @Bean
    @ConditionalOnProperty(prefix = "freerun.platform", name = "media", havingValue = "TENCENT")
    ...
    @Bean
    @ConditionalOnProperty(prefix = "freerun.platform", name = "file", havingValue = "TENCENT")
